...
class CreditCardValidatorTest(unittest.TestCase):
    ...
    Tests are based on the Category Partition method to ensure thorough
    coverage all the rules (as high lighted above) the credit_card_validator
    function is supposed to check.
    """
    def test1(self):
        """
    ...
    def test9(self):
        ...
        invalid length (17) will return False.
        Picked using Category Partition Testing.
        """
...
# Master
    ...
    def test36(self):
        ...
        Based off of test36 triggering bug9 but not test32, it might just be soley an issue with prefix range 2271 
