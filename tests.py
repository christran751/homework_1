...
class CreditCardValidatorTest(unittest.TestCase):
    ...
    def test9(self):
        ...
        """
        self.assertFalse(credit_card_validator("330000985354256")) #330744106849387
    ...
    def test9_1_1(self):
        """
        Verifies if an Amex card that has an invalid prefix that is just below the range by 1 (of 37), an valid Luhn, and but  but valid length one above will return False.
        """
        self.assertFalse(credit_card_validator("3636942614368206")) # 16
    ...
    def test9_2(self):
        ...
        """
        self.assertTrue(credit_card_validator("380000985354256")) #384869385466366

    def test21321(self):
        self.assertTrue(credit_card_validator("340000985354256"))

    def test213213343(self):
        self.assertTrue(credit_card_validator("370000006942069"))
    ...
    def testxxx3(self):
        ...
        """
        self.assertFalse(credit_card_validator("344059105396998")) # 15 digits

    def testxxx4(self):
        """
        Verifies that Amex with valid prefix (34) and length but an invalid Luhn return False
        """
        self.assertFalse(credit_card_validator("370000040420698")) # 15 digits
